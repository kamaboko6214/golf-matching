      ...
      <div class="w-64 flex-shrink-0">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 sticky top-6">
          <div class="text-center mb-4">
            <div class="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-3 text-2xl">
              🏌️
            </div>
          ...
          <p v-if="profile?.bio" class="text-xs text-gray-500 leading-relaxed py-3 border-t border-gray-50">
            {{ profile.bio }}
          </p>
